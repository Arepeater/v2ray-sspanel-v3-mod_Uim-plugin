...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/v2ray/v2ray-core/releases/download/v4.21.1/v2ray-linux-64.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/Albert-Zhan/v2ray-sspanel-v3-mod_Uim-plugin/releases/latest"
